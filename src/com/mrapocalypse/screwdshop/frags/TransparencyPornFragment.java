...
import com.mrapocalypse.screwdshop.prefs.ColorPickerPreference;

import com.android.internal.logging.MetricsProto.MetricsEvent;

public class TransparencyPornFragment extends SettingsPreferenceFragment implements OnPreferenceChangeListener {
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        /*} else if (preference == mQSHeaderAlpha) {
            ...
            mVolumeDialogStrokeColor.setSummary(hexColor);
            Settings.System.putInt(resolver,
                    Settings.System.VOLUME_DIALOG_STROKE_COLOR, mVolumeDialogStrokeColor.getColor());
            return true;
            ...
            Settings.System.putInt(resolver,
                    Settings.System.QS_STROKE_COLOR, mQSStrokeColor.getColor());
            return true;
